...
[![Build Status](https://travis-ci.org/paulconnor/store.svg?branch=master)](https://travis-ci.org/paulconnor/store)
...
6. If you did everything correct, https://paulconnor.github.io/store/ will lead to your new docs
...
- Documentation(ReDoc): https://paulconnor.github.io/store/
- SwaggerUI: https://paulconnor.github.io/store/swagger-ui/
- Look full spec:
    + JSON https://paulconnor.github.io/store/swagger.json
    + YAML https://paulconnor.github.io/store/swagger.yaml
- Preview spec version for branch `[branch]`: https://paulconnor.github.io/store/preview/[branch]
...
1. Run `npm start`
2. Checkout console output to see where local server is started. You can use all [links](#links) (except `preview`) by replacing https://paulconnor.github.io/store/ with url from the message: `Server started <url>`
